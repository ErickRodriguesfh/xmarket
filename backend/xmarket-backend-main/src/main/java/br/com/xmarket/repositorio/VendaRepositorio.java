...
public interface VendaRepositorio extends JpaRepository<Venda, Long> {
    ...
    @Transactional
    @Query(value = 
            "select v.id_venda as codigo_venda, p.imagem_url as nome_imagem, DATE_FORMAT(v.data_venda,'%d/%m/%Y') as data,c.nome,i.quantidade,p.nome as produto,p.preco,(p.preco*i.quantidade) as totalPorProduto " +
